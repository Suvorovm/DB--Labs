--CREATE DATABASE hotel_3A;
--use hotel_3A;

CREATE TABLE Bill
( 
	id_bill              integer  IDENTITY ( 1,1 ),
...
( 
	...
	Option_cost_for_hotel          money  NOT NULL 
)
go
...
ALTER TABLE Contract
	ADD CONSTRAINT R_43 FOREIGN KEY (Id_worker) REFERENCES Worker(Id_worker)
go
